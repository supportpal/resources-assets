        ...
        success: function (response) {
          ...
          if (typeof response.data != 'undefined') {
            ...
            if (response.data.details.update) {
              ...
              $('.sp-ticket-status').text(response.data.details.status).css('background-color', response.data.details.status_colour);
              $('.sp-ticket-priority').text(response.data.details.priority).css('background-color', response.data.details.priority_colour);
