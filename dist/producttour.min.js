!function (e) {
  ...
  function Mt(e) {
    ...
    return {
      c() {
        t = Ne("button"), n = Ne("span"), n.textContent = "×", Ue(n, "aria-hidden", "true"), Ue(t, "aria-label", o = e[0].label ? e[0].label : "Close Tour"), Ue(t, "class", "shepherd-cancel-icon"), Ue(t, "type", "button");
      },
      m(o, s) {
