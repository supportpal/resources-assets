!function () {
  ...
  class e {
    ...
    off(e, i) {
      ...
      0 !== r ? t(e, t => {
        if (1 === r) return void delete this._events[t];
        const e = this._events[t];
  ...
  const i = t => (t = t.filter(Boolean)).length < 2 ? t[0] || "" : 1 == a(t) ? "[" + t.join("") + "]" : "(?:" + t.join("|") + ")",
    ...
    d = t => {
      ...
      return d(i).forEach(function (i) {
        let r = i.slice(0);
        r[0] = t.charAt(0) + r[0], e.push(r), r = i.slice(0), r.unshift(t.charAt(0)), e.push(r);
      }), e;
    },
    p = [[0, 65535]];
  let c, u;
  ...
  const b = t => {
    ...
    y = t => {
      ...
      for (let t in e) {
        let i = e[t];
        i && (r[t] = o(i)), t.length > 1 && n.push(s(t));
      }
      n.sort((t, e) => e.length - t.length);
      const a = i(n);
      return u = new RegExp("^" + a, "u"), r;
    },
    x = (t, e = 1) => (e = Math.max(e, t.length - 1), i(d(t).map(t => ((t, e = 1) => {
      let i = 0;
      return t = t.map(t => (c[t] && (i += t.length), c[t] || t)), i >= e ? r(t) : "";
    })(t, e)))),
    O = (t, e = !0) => {
      let o = t.length > 1 ? 1 : 0;
      return i(t.map(t => {
        let i = [];
        const n = e ? t.length() : t.length() - 1;
        for (let e = 0; e < n; e++) i.push(x(t.substrs[e] || "", o));
        return r(i);
      }));
    },
    _ = (t, e) => {
      for (const i of e) {
        ...
        if (!(i.parts.filter(r).length > 0)) return !0;
      }
      return !1;
    };
  class S {
    ...
    clone(t, e) {
      let i = new S(),
        ...
        o = r.pop();
      for (const t of r) i.add(t);
      let n = e.substr.substring(0, t - o.start),
        s = n.length;
      return i.add({
        start: o.start,
        end: o.start + s,
  ...
  const k = t => {
      ...
      for (let r = 0; r < t.length; r++) {
        let o = t.substring(r).match(u);
        const n = t.substring(r, r + 1),
          s = o ? o[0] : null;
        let a = [],
          l = new Set();
        for (const t of i) {
          const e = t.last();
          if (!e || 1 == e.length || e.end <= r) {
            if (s) {
              const e = s.length;
              t.add({
                start: r,
    ...
    A = (t, e) => {
      if (t) {
        for (var i, r = e.split("."); (i = r.shift()) && (t = t[i]););
        return t;
      }
    },
    C = (t, e, i) => {
      var r, o;
      return t ? (t += "", null == e.regex || -1 === (o = t.search(e.regex)) ? 0 : (r = e.string.length / t.length, 0 === o && (r += .5), r * i)) : 0;
    },
    F = (t, e) => {
      var i = t[e];
  ...
  class T {
    ...
    tokenize(t, e, i) {
      ...
      const r = [],
        o = t.split(/\s+/);
      var n;
      return i && (n = new RegExp("^(" + Object.keys(i).map(s).join("|") + "):(.*)$")), o.forEach(t => {
        let i,
          o = null,
          a = null;
        n && (i = t.match(n)) && (o = i[1], t = i[2]), t.length > 0 && (a = this.settings.diacritics ? k(t) || null : s(t), a && e && (a = "\\b" + a)), r.push({
          string: t,
    ...
    _getScoreFunction(t) {
      ...
      const a = 1 === n ? function (t, e) {
        const i = r[0].field;
        return C(s(e, i), t, o[i] || 1);
      } : function (t, e) {
        var i = 0;
        if (t.field) {
          const r = s(e, t.field);
          !t.regex && r ? i += 1 / n : i += C(r, t, 1);
        } else L(o, (r, o) => {
          i += C(s(e, o), t, r);
        });
        return i / n;
    ...
    _getSortFunction(t) {
      ...
      const r = this,
        o = t.options,
        n = !t.query && o.sort_empty ? o.sort_empty : o.sort;
      if ("function" == typeof n) return n.bind(this);
      const s = function (e, i) {
        return "$score" === e ? i.score : t.getAttrFn(r.items[i.id], e);
      };
      ...
      return i.length ? function (t, e) {
        var r, o;
        for (let n of i) {
          if (o = n.field, r = ("desc" === n.direction ? -1 : 1) * E(s(o, t), s(o, e))) return r;
        }
        return 0;
      } : null;
    }
    prepareSearch(t, e) {
      ...
      if (F(r, "sort"), F(r, "sort_empty"), r.fields) {
        F(r, "fields");
        const t = [];
        r.fields.forEach(e => {
          "string" == typeof e && (e = {
      ...
      return {
        ...
        tokens: this.tokenize(t, r.respect_word_boundaries, i),
        total: 0,
        items: [],
        weights: i,
        getAttrFn: r.nesting ? A : I
      };
    }
    search(t, e) {
      var i,
        r,
        o = this;
      r = this.prepareSearch(t, e), e = r.options, t = r.query;
      const n = e.score || o._getScoreFunction(r);
      t.length ? L(o.items, (t, o) => {
        i = n(t), (!1 === e.filter || i > 0) && r.items.push({
          score: i,
          id: o
        });
      }) : L(o.items, (t, e) => {
      ...
      return s && r.items.sort(s), r.total = r.items.length, "number" == typeof e.limit && (r.items = r.items.slice(0, e.limit)), r;
    }
  }
    ...
    j = (t, e) => {
      ...
      return function (r, o) {
        ...
        i && (n.loading = Math.max(n.loading - 1, 0), clearTimeout(i)), i = setTimeout(function () {
          i = null, n.loadedSearches[r] = !0, t.call(n, r, o);
        }, e);
      };
    },
    V = (t, e, i) => {
      var r,
        o = t.trigger,
        n = {};
      for (r of (t.trigger = function () {
        var i = arguments[0];
        if (-1 === e.indexOf(i)) return o.apply(t, arguments);
        n[i] = arguments;
      }, i.apply(t, []), t.trigger = o, e)) r in n && o.apply(t, n[r]);
    },
    q = (t, e = !1) => {
    ...
    nt = (t, e) => {
      ...
      const i = t => 3 === t.nodeType ? (t => {
        ...
        if (i && t.data.length > 0) {
          ...
          var o = t.splitText(i.index);
          o.splitText(i[0].length);
          var n = o.cloneNode(!0);
          return r.appendChild(n), ot(o, r), 1;
        }
        return 0;
      })(t) : ((t => {
  ...
  function lt(t, e) {
    ...
    return "select" === p ? (() => {
      ...
      var m = t => {
        ...
        f = (t, e) => {
          var r = P(t.value);
          if (null != r && (r || i.allowEmptyOption)) {
            if (c.hasOwnProperty(r)) {
              if (e) {
                var l = c[r][a];
                l ? Array.isArray(l) ? l.push(e) : c[r][a] = [l, e] : c[r][a] = e;
              }
            } else {
              var d = m(t);
              d[o] = d[o] || t.textContent, d[n] = d[n] || r, d[s] = d[s] || t.disabled, d[a] = d[a] || e, d.$option = t, d.$order = d.$order || ++g, c[r] = d, p.push(d);
            }
            t.selected && u.items.push(r);
          }
        };
      u.maxItems = t.hasAttribute("multiple") ? null : 1, K(t.children, t => {
        var i, r, o;
        "optgroup" === (e = t.tagName.toLowerCase()) ? ((o = m(i = t))[l] = o[l] || i.getAttribute("label") || "", o[d] = o[d] || h++, o[s] = o[s] || i.disabled, o.$order = o.$order || ++g, u.optgroups.push(o), r = o[d], K(i.children, t => {
          f(t, r);
        })) : "option" === e && f(t);
      });
    })() : (() => {
      ...
      if (a) u.options = JSON.parse(a), K(u.options, t => {
        ...
        const r = l.split(i.delimiter);
        K(r, t => {
          const e = {};
          e[o] = t, e[n] = t, u.options.push(e);
        }), u.items = r;
      }
  ...
  class pt extends function (t) {
    return t.plugins = {}, class extends t {
      ...
      initializePlugins(t) {
        ...
        if (Array.isArray(t)) t.forEach(t => {
          "string" == typeof t ? o.push(t) : (r.plugins.settings[t.name] = t.options, o.push(t.name));
        });else if (t) for (e in t) t.hasOwnProperty(e) && (r.plugins.settings[e] = t[e], o.push(e));
        for (; i = o.shift();) r.require(i);
      }
      loadPlugin(e) {
        var i = this,
          r = i.plugins,
        ...
        r.requested[e] = !0, r.loaded[e] = o.fn.apply(i, [i.plugins.settings[e] || {}]), r.names.push(e);
      }
      require(t) {
        var e = this,
          i = e.plugins;
    ...
    constructor(t, e) {
      ...
      r.tomselect = this, i = (window.getComputedStyle && window.getComputedStyle(r, null)).getPropertyValue("direction");
      const o = lt(r, e);
      this.settings = o, this.input = r, this.tabIndex = r.tabIndex || 0, this.is_select_tag = "select" === r.tagName.toLowerCase(), this.rtl = /rtl/i.test(i), this.inputId = H(r, "tomselect-" + dt), this.isRequired = r.required, this.sifter = new T(this.options, {
      ...
      var n = o.createFilter;
      "function" != typeof n && ("string" == typeof n && (n = new RegExp(n)), n instanceof RegExp ? o.createFilter = t => n.test(t) : o.createFilter = t => this.settings.duplicates || !this.options[t]), this.initializePlugins(o.plugins), this.setupCallbacks(), this.setupTemplates();
      const s = G("<div>"),
        a = G("<div>"),
        ...
        c = o.mode;
      var u;
      if (Y(s, o.wrapperClass, p, c), Y(a, o.controlClass), B(s, a), Y(l, o.dropdownClass, c), o.copyClassesToDropdown && Y(l, p), Y(d, o.dropdownContentClass), B(l, d), G(o.dropdownParent || s).appendChild(l), Q(o.controlInput)) {
        u = G(o.controlInput);
        K(["autocorrect", "autocapitalize", "autocomplete", "spellcheck", "aria-label"], t => {
          r.getAttribute(t) && rt(u, {
            [t]: r.getAttribute(t)
          });
        }), u.tabIndex = -1, a.appendChild(u), this.focus_node = u;
      } else o.controlInput ? (u = G(o.controlInput), this.focus_node = u) : (u = G("<input/>"), this.focus_node = a);
    ...
    setup() {
      ...
      (null === e.maxItems || e.maxItems > 1) && t.is_select_tag && rt(l, {
        multiple: "multiple"
      }), e.placeholder && rt(i, {
        placeholder: e.placeholder
      }), !e.splitOn && e.delimiter && (e.splitOn = new RegExp("\\s*" + s(e.delimiter) + "+\\s*")), e.load && e.loadThrottle && (e.load = j(e.load, e.loadThrottle)), N(r, "mousemove", () => {
        t.ignoreHover = !1;
      }), N(r, "mouseenter", e => {
        var i = tt(e.target, "[data-selectable]", r);
        ...
        var r = tt(e.target, "[data-ts-item]", a);
        r && t.onItemSelect(e, r) ? q(e, !0) : "" == i.value && (t.onClick(), q(e, !0));
      ...
      const f = e => {
          ...
          if (!n.contains(o) && !r.contains(o)) return t.isFocused && t.blur(), void t.inputState();
          o == i && t.isOpen ? e.stopPropagation() : q(e, !0);
        },
        v = () => {
    ...
    onOptionSelect(t, e) {
      ...
      }) : void 0 !== (i = e.dataset.value) && (r.isDropdownContentStale = r.settings.hideSelected, r.addItem(i), r.settings.closeAfterSelect ? r.close() : r.settings.clearAfterSelect && r.setTextboxValue(), !r.settings.hideSelected && t.type && /click/.test(t.type) && r.setActiveOption(e)));
    }
    canSelect(t) {
    ...
    setActiveItem(t, e) {
      ...
      if ("single" !== l.settings.mode) {
        ...
        if ("click" === (i = e && e.type.toLowerCase()) && R("shiftKey", e) && l.activeItems.length) {
          for (a = l.getLastActive(), (o = Array.prototype.indexOf.call(l.control.children, a)) > (n = Array.prototype.indexOf.call(l.control.children, t)) && (s = o, o = n, n = s), r = o; r <= n; r++) t = l.control.children[r], -1 === l.activeItems.indexOf(t) && l.setActiveItemClass(t);
          q(e);
    ...
    setActiveOption(t, e = !0) {
      t !== this.activeOption && (this.clearActiveOption(), t && (this.activeOption = t, rt(this.focus_node, {
    ...
    scrollToOption(t, e) {
      ...
      const i = this.dropdown_content,
        ...
        o = i.scrollTop || 0,
        n = t.offsetHeight,
        s = t.getBoundingClientRect().top - i.getBoundingClientRect().top + o;
      s + n > r + o ? this.scroll(s - r + n, e) : s < o && this.scroll(s, e);
    }
    scroll(t, e) {
      const i = this.dropdown_content;
    ...
    clearActiveOption() {
      this.activeOption && (U(this.activeOption, "active"), rt(this.activeOption, {
        "aria-selected": null
      })), this.activeOption = null, rt(this.focus_node, {
    ...
    inputState() {
      var t = this;
      t.control.contains(t.control_input) && (rt(t.control_input, {
        placeholder: t.settings.placeholder
      }), t.activeItems.length > 0 || !t.isFocused && t.settings.hidePlaceholder && t.items.length > 0 ? (t.setTextboxValue(), t.isInputHidden = !0) : (t.settings.hidePlaceholder && t.items.length > 0 && rt(t.control_input, {
        placeholder: ""
    ...
    search(t) {
      ...
      if (r.settings.score && "function" != typeof (i = r.settings.score.call(r, t))) throw new Error('Tom Select "score" setting must be a function that returns a function');
      return r.isDropdownContentStale || t !== r.lastQuery ? (r.lastQuery = t, /(.)\1{15,}/.test(t) && (t = ""), e = r.sifter.search(t, Object.assign(o, {
        score: i
      })), r.currentResults = e) : e = Object.assign({}, r.currentResults), r.settings.hideSelected && (e.items = e.items.filter(t => {
        let e = P(t.id);
        return !(null !== e && -1 !== r.items.indexOf(e));
      })), e;
    }
    refreshOptions(t = !0) {
      var e, i, r, o, n, s, a, l, d, p;
      const c = {},
        u = [];
      var h = this,
        g = h.inputValue();
      ...
      m && (v = h.activeOption) && (d = v.closest("[data-group]")), o = f.items.length, "number" == typeof h.settings.maxOptions && (o = Math.min(o, h.settings.maxOptions)), o > 0 && (w = !0);
      const y = (t, e) => {
        let i = c[t];
        if (void 0 !== i) {
          let t = u[i];
      ...
      for (e = 0; e < o; e++) {
        ...
        let l = z(o),
          p = h.getOption(l, !0);
        for (h.settings.hideSelected || p.classList.toggle("selected", h.items.includes(l)), n = a[h.settings.optgroupField] || "", i = 0, r = (s = Array.isArray(n) ? n : [n]) && s.length; i < r; i++) {
          n = s[i];
          let t = a.$order,
            e = h.optgroups[n];
          var x;
          ...
          const [r, l] = y(n, t);
          i > 0 && (p = p.cloneNode(!0), rt(p, {
            id: a.$id + "-clone-" + i,
            "aria-selected": null
          }), p.classList.add("ts-cloned"), U(p, "active"), h.activeOption && h.activeOption.dataset.value == o && d && d.dataset.group === n.toString() && (v = p)), l.appendChild(p), "" != n && (c[n] = r);
        }
      }
      var O;
      h.settings.lockOptgroupOrder && u.sort((t, e) => t.order - e.order), a = document.createDocumentFragment(), K(u, t => {
        ...
        if (void 0 !== r) {
          let t = document.createDocumentFragment(),
            i = h.render("optgroup_header", r);
          B(t, i), B(t, e);
          let o = h.render("optgroup", {
            group: r,
            options: t
          });
          B(a, o);
    ...
    addOption(t, e = !1) {
      ...
      const r = P(t[i.settings.valueField]);
      return null === r || i.options.hasOwnProperty(r) ? (i.updateOption(t[i.settings.valueField], t), !1) : (t.$order = t.$order || ++i.order, t.$id = i.inputId + "-opt-" + t.$order, i.options[r] = t, i.isDropdownContentStale = !0, e && (i.userOptions[r] = e, i.trigger("option_add", r, t)), r);
    }
    addOptions(t, e = !1) {
      K(t, t => {
        this.addOption(t, e);
    ...
    updateOption(t, e) {
      ...
      d && (-1 !== (o = i.items.indexOf(n)) && i.items.splice(o, 1, s), r = i._render("item", e), d.classList.contains("active") && Y(r, "active"), ot(d, r)), i.isDropdownContentStale = !0;
    }
    removeOption(t, e) {
      const i = this;
    ...
    getOption(t, e = !1) {
      ...
      if (null != r) {
        ...
        if (e) return this._render("option", r);
      }
      return null;
    }
    getAdjacent(t, e, i = "option") {
      var r;
      if (!t) return null;
      r = "item" == i ? this.controlChildren() : this.dropdown_content.querySelectorAll("[data-selectable]");
      for (let i = 0; i < r.length; i++) if (r[i] == t) return e > 0 ? r[i + 1] : r[i - 1];
      return null;
    }
    getItem(t) {
    ...
    addItems(t, e) {
      ...
      const o = (r = r.filter(t => -1 === i.items.indexOf(t)))[r.length - 1];
      r.forEach(t => {
        i.isPending = t !== o, i.addItem(t, e);
      });
    }
    addItem(t, e) {
      V(this, e ? [] : ["change", "dropdown_close"], () => {
        ...
        const o = this,
          n = o.settings.mode,
          s = P(t);
        if ((!s || -1 === o.items.indexOf(s) || ("single" === n && o.close(), "single" !== n && o.settings.duplicates)) && null !== s && o.options.hasOwnProperty(s) && ("single" === n && o.clear(e), "multi" !== n || !o.isFull())) {
          if (i = o._render("item", o.options[s]), o.control.contains(i) && (i = i.cloneNode(!0)), r = o.isFull(), o.items.splice(o.caretPos, 0, s), o.insertAtCaret(i), o.isSetup) {
            if (!o.isPending && o.settings.hideSelected) {
              let t = o.getOption(s),
                e = o.getAdjacent(t, 1);
              e && o.setActiveOption(e);
            }
            o.settings.clearAfterSelect && o.setTextboxValue(), o.isPending || o.settings.closeAfterSelect || o.refreshOptions(o.isFocused && "single" !== n), 0 != o.settings.closeAfterSelect && o.isFull() ? o.close() : o.isPending || o.positionDropdown(), o.trigger("item_add", s, i), o.isPending || o.updateOriginalInput({
              silent: e
            });
          }
    ...
    removeItem(t = null, e) {
      ...
      r = it(t), t.remove(), t.classList.contains("active") && (o = i.activeItems.indexOf(t), i.activeItems.splice(o, 1), U(t, "active")), i.items.splice(r, 1), i.isDropdownContentStale = !0, !i.settings.persist && i.userOptions.hasOwnProperty(n) && i.removeOption(n, e), r < i.caretPos && i.setCaret(i.caretPos - 1), i.updateOriginalInput({
        silent: e
    ...
    createItem(t = null, e = () => {}) {
      ...
      var i,
        r = this,
        o = r.caretPos;
      if (t = t || r.inputValue(), !r.canCreate(t)) {
        return P(t) && this.options[t] && r.addItem(t), e(), !1;
      }
      r.lock();
      var n = !1,
        s = t => {
          if (r.unlock(), !t || "object" != typeof t) return e();
          var i = P(t[r.settings.valueField]);
          if ("string" != typeof i) return e();
          r.setTextboxValue(), r.addOption(t, !0), r.setCaret(o), r.addItem(i), e(t), n = !0;
        };
      return i = "function" == typeof r.settings.create ? r.settings.create.call(this, t, s) : {
        [r.settings.labelField]: t,
        [r.settings.valueField]: t
      }, n || s(i), !0;
    }
    refreshItems() {
      var t = this;
    ...
    refreshState() {
      ...
      var o;
      r.toggle("focus", t.isFocused), r.toggle("disabled", t.isDisabled), r.toggle("readonly", t.isReadOnly), r.toggle("required", t.isRequired), r.toggle("invalid", !t.isValid), r.toggle("locked", i), r.toggle("full", e), r.toggle("input-active", t.isFocused && !t.isInputHidden), r.toggle("dropdown-active", t.isOpen), r.toggle("has-options", (o = t.options, 0 === Object.keys(o).length)), r.toggle("has-items", t.items.length > 0);
    }
    ...
    updateOriginalInput(t = {}) {
      ...
      if (e.is_select_tag) {
        ...
        function a(t, i, r) {
          return t || (t = G('<option value="' + D(i) + '">' + D(r) + "</option>")), t != o && e.input.append(t), n.push(t), (t != o || s > 0) && (t.selected = !0), t;
        }
        e.input.querySelectorAll("option:checked").forEach(t => {
          t.selected = !1;
        }), 0 == e.items.length && "single" == e.settings.mode ? a(o, "", "") : e.items.forEach(t => {
          if (i = e.options[t], r = i[e.settings.labelField] || "", n.includes(i.$option)) {
            a(e.input.querySelector(`option[value="${M(t)}"]:not(:checked)`), t, r);
          } else i.$option = a(i.$option, t, r);
        });
    ...
    open() {
      var t = this;
      t.isLocked || t.isOpen || "multi" === t.settings.mode && t.isFull() || (t.isOpen = !0, rt(t.focus_node, {
        "aria-expanded": "true"
    ...
    close(t = !0) {
      var e = this,
        i = e.isOpen;
      t && (e.setTextboxValue(), "single" === e.settings.mode && e.items.length && e.inputState()), e.isOpen = !1, rt(e.focus_node, {
        "aria-expanded": "false"
      }), J(e.dropdown, {
        display: "none"
    ...
    insertAtCaret(t) {
      const e = this,
        i = e.caretPos,
        r = e.control;
      r.insertBefore(t, r.children[i] || null), e.setCaret(i + 1);
    }
    deleteSelection(t) {
      var e,
        i,
      ...
      const a = [];
      if (s.activeItems.length) o = et(s.activeItems, e), r = it(o), e > 0 && r++, K(s.activeItems, t => a.push(t));else if ((s.isFocused || "single" === s.settings.mode) && s.items.length) {
        const t = s.controlChildren();
        let r;
        e < 0 && 0 === i.start && 0 === i.length ? r = t[s.caretPos - 1] : e > 0 && i.start === s.inputValue().length && (r = t[s.caretPos]), void 0 !== r && a.push(r);
      }
      if (!s.shouldDelete(a, t)) return !1;
      for (q(t, !0), void 0 !== r && s.setCaret(r); a.length;) s.removeItem(a.pop());
    ...
    advanceSelection(t, e) {
      var i,
        r,
        o = this;
      o.rtl && (t *= -1), o.inputValue().length || (R(st, e) || R("shiftKey", e) ? (r = (i = o.getLastActive(t)) ? i.classList.contains("active") ? o.getAdjacent(i, t, "item") : i : t > 0 ? o.control_input.nextElementSibling : o.control_input.previousElementSibling) && (r.classList.contains("active") && o.removeActiveItem(i), o.setActiveItemClass(r)) : o.moveCaret(t));
    }
    moveCaret(t) {}
    getLastActive(t) {
    ...
    render(t, e) {
      ...
      if (!(r = o.settings.render[t].call(this, e, D))) return null;
      if (r = G(r), "option" === t || "option_create" === t ? e[o.settings.disabledField] ? rt(r, {
        "aria-disabled": "true"
      }) : rt(r, {
        "data-selectable": ""
      }) : "optgroup" === t && (i = e.group[o.settings.optgroupValueField], rt(r, {
        "data-group": i
      }), e.group[o.settings.disabledField] && rt(r, {
        "data-disabled": ""
      })), "option" === t || "item" === t) {
        const i = z(e[o.settings.valueField]);
        rt(r, {
          "data-value": i
        }), "item" === t ? (Y(r, o.settings.itemClass), rt(r, {
          "data-ts-item": ""
        })) : (Y(r, o.settings.optionClass), rt(r, {
          role: "option",
          id: e.$id
        }), e.$div = r, o.options[i] = e);
      }
      return r;
    }
    _render(t, e) {
    ...
    hook(t, e, i) {
      ...
      r[e] = function () {
        var e, n;
        return "after" === t && (e = o.apply(r, arguments)), n = i.apply(r, arguments), "instead" === t ? n : ("before" === t && (e = o.apply(r, arguments)), e);
      };
    }
  }
  !function (t, e) {
    ...
    if ("undefined" != typeof document) {
      ...
      o.type = "text/css", "top" === i && r.firstChild ? r.insertBefore(o, r.firstChild) : r.appendChild(o), o.styleSheet ? o.styleSheet.cssText = t : o.appendChild(document.createTextNode(t));
    }
  ...
  pt.define("remove_button", function (t) {
    ...
    var i = this;
    if (e.append) {
      var r = '<a href="javascript:void(0)" class="' + e.className + '" tabindex="-1" title="' + ((e.title + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") + '">') + e.label + "</a>";
      i.hook("after", "setupTemplates", () => {
        var t = i.settings.render.item;
        i.settings.render.item = (e, o) => {
          var n = ht(t.call(i, e, o)),
            s = ht(r);
    ...
    e.on("item_remove", function (t) {
      if (e.isFocused && "" === e.control_input.value.trim()) {
        var r = e.options[t];
        r && e.setTextboxValue(i.text.call(e, r));
      }
    });
    ...
    this.hook("after", "setupTemplates", () => {
      ...
      t.settings.render.item = function (i, r) {
        const o = t.options[i.value] || i;
        let n = e.call(t, i, r);
        return o.unremovable && n && n.classList && n.classList.add("unremovable"), n;
      };
    });
    const e = t.removeItem;
    this.hook("instead", "removeItem", (i, r) => {
      const o = t.getItem(i);
      return !(o && o.classList && o.classList.contains("unremovable")) && e.call(t, i, r);
    });
  }), function (t) {
    const e = {
      hidePlaceholder: !0,
    ...
    function i(t) {
      ...
      var r;
      return i.plugins = (r = t.plugins, Array.isArray(r) ? [...r, "load_fn"] : "object" == typeof r ? {
        ...r,
        load_fn: {}
      } : ["load_fn"]), i;
    }
    t.fn.selectize = function (e) {
      return this.each(function () {
        ...
        const o = i(e || {});
        this.tomselect = this.selectize = new pt(this, o), r.data("selectize", this.tomselect);
      });
    };
  }(jQuery);
}();