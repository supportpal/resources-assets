!function (t, e) {
  ...
  function e(t) {
    ...
    this.callback = function (t) {
      ...
      var r = function (t) {
        n.find("button:visible").prop("disabled", !1).trigger("click"), Swal.fire(Lang.get("messages.error"), t || Lang.get("messages.general_error"), "error");
      };
      n.find("button.switch-view").prop("disabled", !0), a.html("").css(s.position()).css("width", s.outerWidth(!0)).css("height", s.outerHeight(!0)).addClass("loadinggif").show();
      ...
      $.post(laroute.route("core.operator.emailtemplate.preview"), {
        ...
        n.find("button.switch-view").prop("disabled", !1), a.removeClass("loadinggif");
      });
      ...
      s = t.after('<div class="sp-editor-container"></div>'), e = s.next(".sp-editor-container"), a = $('<div class="sp-editor-preview sp-editor-content"></div>').hide(), e.append(a), n = $('<div class="sp:inline-block sp:mt-3"><button class="switch-view visual-preview" type="button">' + Lang.get("general.preview") + '</button><button class="switch-view code-editor sp:hidden" type="button">' + Lang.get("general.editor") + "</button></div>").on("click", "button", function (t) {
        t.preventDefault(), $(this).hasClass("visual-preview") ? r.showPreview() : r.showEditor(), e.find(".switch-view").toggle();
      }), e.append(n);
    };
  }
  e.translations = {
