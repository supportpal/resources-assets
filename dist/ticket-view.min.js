  ...
  var d = function () {
    ...
    l = function (e) {
      function t(t) {
        ...
        return s.messageId = "newMessage", s.noteId = "newNote", s.forwardId = "newForward", s.replyTemplate = t, s;
      }
      return o(t, e), t.prototype.getTextEditors = function () {
        ...
        this.setDraft(this.messageId, e);
      }, t.prototype.setNoteDraft = function (e) {
        this.setDraft(this.noteId, e);
      }, t.prototype.setForwardDraft = function (e) {
        this.setDraft(this.forwardId, e);
