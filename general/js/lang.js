(function () {
  ...
  var applyReplacements = function (message, replacements) {
    for (var replacementName in replacements) {
      ...
      // 'welcome' => 'Welcome, :Name' => 'Welcome, Dayle'
      message = message.replace(new RegExp(':' + (replacementName.charAt(0).toUpperCase() + replacementName.substr(1)), 'g'), replacement.charAt(0).toUpperCase() + replacement.substr(1));
    }
    return message;
  };
